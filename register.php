...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-8 mx-auto border shadow p-4">
            <h2 class="text-center mb-4">Înregistrează-te acum</h2>
            <hr />

            <form method="post">

                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Numele dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Prenume dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Emailul dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Telefonul dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Adresa dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label for="Rol" class="col-sm-3 col-form-label">Selectați rolul:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Parola dumneavoastră:</label>
                    <div class="col-sm-9">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Confirmare parolă:</label>
                    <div class="col-sm-9">
            ...
            <div class="text-center mt-4">
                <p><b>Ai deja cont?</b></p>
                <a href="login.php" class="btn btn-success">Logează-te</a>
            </div>
        </div>
    </div>
</div>
